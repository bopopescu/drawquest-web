...
FLAG_WORD_FRAGMENTS = ['fuck', 'nigger', 'n1gg', 'hitler', 'faggot', 'bollock', 'blowjob', 'handjob', 'asshole', 'c0ck', 'douchebag', 'jizz', 'masturbat', 'mainbat', 'niggah', 'phonesex', 'cybersex', 'shitter', 'shithead', 'testicle', 'testical', 'testicular', 'fatass', 'rimjob', 'cocksuck', 'cocksuk', 'cokehead', 'cocaine', 'ch1nk', 'ballsack', 'b00b', 'a55', '4r5e', '5hit', 'a_s_s', 'fukwit', 'jizm', 'f_u_c_k', 'nignog', 'n1gn0g', 'ejakulat', 'm45terb', 'm45turb', 'assmunch', 'cockmunch', 'foreskin', 'prostitut', 'nympho']
